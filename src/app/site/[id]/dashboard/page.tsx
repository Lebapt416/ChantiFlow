      ...
      <div className="space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-4">
          <div className="rounded border border-rule-soft bg-paper p-5 dark:border-rule dark:bg-ink">
            ...
            <p className="mt-2 text-3xl font-semibold text-ink dark:text-paper">{totalTasks}</p>
          ...
          <div className="rounded border border-rule-soft bg-paper p-5 dark:border-rule dark:bg-ink">
            <p className="text-xs uppercase tracking-[0.3em] text-ink-3">Équipe</p>
            <p className="mt-2 text-3xl font-semibold text-ink dark:text-paper">{workers?.length ?? 0}</p>
            <p className="text-sm text-ink-3">membres</p>
          </div>
        </section>
        ...
        <section className="rounded border border-rule-soft bg-paper p-6 dark:border-rule dark:bg-ink">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="font-serif text-[22px] text-ink dark:text-paper">
                Planning du jour
              </h3>
            ...
            <div className="space-y-3">
              {todaysTasks.map((task) => {
                ...
                return (
                  <div
                    key={task.taskId}
                    className="rounded border border-rule-soft bg-paper-2 p-4 dark:border-rule dark:bg-ink"
                  >
        ...
        <section className="rounded border border-rule-soft bg-paper p-6 dark:border-rule dark:bg-ink">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="font-serif text-[22px] text-ink dark:text-paper">Rapports</h3>
              <p className="text-sm text-ink-3">
