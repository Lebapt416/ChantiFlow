      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800">
          <div className="flex items-start gap-3">
            <div className="rounded-lg bg-paper-2 p-2 dark:bg-paper-2">
              <Users className="h-5 w-5 text-orange dark:text-green" />
            </div>
            <div className="flex-1">
              ...
              {currentAddOns.extra_workers ? (
                <p className="mt-2 text-xs font-medium text-orange dark:text-green">
          ...
          <button
            ...
            className="mt-4 w-full rounded-md bg-orange px-4 py-2 text-sm font-medium text-white transition hover:bg-orange-dark disabled:cursor-not-allowed disabled:opacity-70"
          >
