...
export function ValidateReportButton({ reportId, taskId }: Props) {
  ...
  return (
    <button
      ...
      disabled={isPending}
      className="w-full rounded bg-orange px-6 py-3 text-base font-semibold text-paper transition hover:bg-orange-dark disabled:cursor-not-allowed disabled:opacity-70 flex items-center justify-center gap-2"
    >
