...
import { WorkerScanner } from '../dashboard/worker-scanner';
import { WorkerNav } from '../components/worker-nav';

export const dynamic = 'force-dynamic';

export default async function WorkerScannerPage() {
        ...
        <div className="mx-auto flex max-w-5xl flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-2xl font-semibold text-zinc-900 dark:text-white">Scanner un chantier</h1>
              <p className="text-sm text-zinc-500 dark:text-zinc-400">
                Rejoignez instantanément un site en scannant son QR code officiel.
              </p>
            </div>
          </div>
          <Link
